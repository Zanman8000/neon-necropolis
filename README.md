...
| Quick knife | V |
| Grenade / throwing knife | G / T (looted from dead zombies) |
...
- Power-up drops from kills: Max Ammo, Insta-Kill, Double Points, Nuke and Carpenter. Dead zombies also drop grenades and throwing knives.
- You can jump onto benches, planters and desks; low props are stepped over automatically.
...
1. Real character models and animations to replace the procedural placeholders.
2. Balance pass, performance pass and cross-browser testing for v1.0.
